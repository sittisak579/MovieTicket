...
class every extends movie1038 implements Movie07,Movie08,Movie09,Movie10,Movie11,Movie12  {
    ...
    System.out.println("\n:::::::"
            + "Bill:::::::");System.out.println(every.get(j));}    
    }
...
public int SelectMovie(int a){
    switch(a){
        ...
        case 3:println9(); break;
        case 4:println10(); break;
        case 5:println11(); break;
        case 6:println12(); break;
    }
    return (int)total;
    }
